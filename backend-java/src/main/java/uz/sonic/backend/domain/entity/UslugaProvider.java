...
@Entity
@Table(name = "usluga_providers", indexes = {
        @Index(name = "idx_usluga_providers_user_id", columnList = "user_id"),
        @Index(name = "idx_usluga_providers_city", columnList = "city")
})
@Getter
@Setter
@NoArgsConstructor
...
public class UslugaProvider {
    ...
    @Column(name = "price_surma")
    private Integer priceSurma = 0;
