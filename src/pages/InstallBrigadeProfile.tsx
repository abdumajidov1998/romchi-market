...
import { Btn, Card, EmptyState, TelegramIcon, tgHref } from '../ui';
import { api } from '../api';
...
export const InstallBrigadeProfile: React.FC = () => {
  const { id } = useParams();
  ...
  if (error || !b) return <EmptyState icon="🔎" title="Topilmadi" sub={error} ctaLabel="Orqaga" onCta={() => nav('/ustanofka')} />;
