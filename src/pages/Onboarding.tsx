  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', padding: 14 }}>
      <div style={{ width: '100%', maxWidth: 440, background: '#fff', borderRadius: 18, padding: 16, boxShadow: 'var(--shadow-lg)' }}>
        <button onClick={() => nav('/')} style={{ width: 34, height: 34, borderRadius: 10, background: '#f5f5f5', border: '1px solid var(--line)', fontSize: 14, cursor: 'pointer', marginBottom: 6 }}><img src="/images/back.png" alt="orqaga" style={{ width: 16, height: 16, display: 'block', margin: 'auto' }} /></button>
        ...
        <Btn full onClick={() => nav(choice === 'worker' ? '/jobs' : '/workers')} style={{ marginTop: 10, padding: '14px' }}>Davom etish</Btn>
